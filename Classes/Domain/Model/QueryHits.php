...
class QueryHits implements \TYPO3\CMS\Extbase\Persistence\QueryResultInterface
{
    ...
    public function execute()
    {
        ...
        return array_combine(range($this->_offset + 1,
            min($this->_offset + $this->_limit, $this->_offset + count($hits))), $hits);
    }
    ...
    {
        return (($field === null) || ($this->_highlight === null)) ? $this->_highlight : (($field && array_key_exists($field,
                $this->_highlight)) ? $this->_highlight[$field] : null);
    }
}
