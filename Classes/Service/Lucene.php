    ...
    public function find($searchTerm, &$query = null)
    {
        ...
        if (strlen($searchTerm)) {
            ...
            try {
                ...
                $hits = new \Tollwerk\TwLucenesearch\Domain\Model\QueryHits($this->_index(), $query, $tokenTerms,
                    (boolean)$highlight);
    ...
    protected function _index()
    {
        ...
        if ($this->_index === null) {
            ...
            $this->_index->setMergeFactor(max(1,
                intval($GLOBALS['TYPO3_CONF_VARS']['EXT']['extParams']['tw_lucenesearch']['mergeFactor'])));
