...
class Wizicon {
	...
	function includeLocalLang()	{
		...
		return $parserFactory->getParsedData(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('tw_lucenesearch', 'Resources'.DIRECTORY_SEPARATOR.'Private'.DIRECTORY_SEPARATOR.'Language'.DIRECTORY_SEPARATOR.'locallang.xlf'), $GLOBALS['LANG']->lang, 'utf-8', 1);
	}
}
