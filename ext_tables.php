...
$GLOBALS['TCA']['tt_content']['types']['list']['subtypes_addlist']['twlucenesearch_lucenece'] = 'pi_flexform';
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    'twlucenesearch_lucenece',
    'FILE:EXT:tw_lucenesearch/Configuration/FlexForms/ControllerActions.xml'
);

$GLOBALS['TCA']['tt_content']['types']['list']['subtypes_addlist']['twlucenesearch_lucene'] = 'pi_flexform';
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue(
    'twlucenesearch_lucene',
    'FILE:EXT:tw_lucenesearch/Configuration/FlexForms/ControllerActions.xml',
);
...
$TBE_MODULES_EXT['xMOD_db_new_content_el']['addElClasses']['Tollwerk\\TwLucenesearch\\Wizicon'] = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath(
    'tw_lucenesearch',
...
set_include_path(
    implode(
        ...
        array_unique(
            array_merge(
                array(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('tw_lucenesearch', 'Classes')),
...
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
    ...
    array(          // Additional configuration
        'access' => 'user,group',
        'icon' => 'EXT:tw_lucenesearch/Resources/Public/Icons/module-lucenesearch.svg',
        'labels' => 'LLL:EXT:tw_lucenesearch/Resources/Private/Language/locallang_mod.xml',
    )
);
